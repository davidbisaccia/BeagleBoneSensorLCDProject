...
namespace BeagleBone
{
    namespace Controllers
    {
        ...
        void CommunicationProcess::Start()
        {
            _stop = false;
        ...
        void CommunicationProcess::NewConnection()
        {
            ...
            Communication::SocketHandler* handler = new Communication::SocketHandler(this, socket);
        ...
        {
            emit SendStatus("Communication Process Error");
        }
        ...
        void CommunicationProcess::DropConnection(const int& id)
        {
            for(int i = 0; i < _sockets.size(); i++)
            {
                ...
                {
                    Communication::SocketHandler* temp = _sockets[i];
                    _sockets.removeAt(i);
                    delete temp;
